...
pub const STACK_END: *mut u8 = 0x7c00 as *mut u8;
...
const TOTAL_SECTORS: usize = STAGE_0_SECTIONS + SECTORS_TO_READ;

/// Start of the PML4T, takes up 0x1000 = 8 * 0x200 bytes
pub const PML4T_START: *mut [u64; 0x200] = 0x20000 as *mut [u64; 0x200];
/// Start of the PDPT,  takes up 0x1000 = 8 * 0x200 bytes
pub const PDPT_START: *mut [u64; 0x200] = 0x21000 as *mut [u64; 0x200];
/// Start of the PDT,   takes up 0x1000 = 8 * 0x200 bytes
pub const PDT_START: *mut [u64; 0x200] = 0x22000 as *mut [u64; 0x200];
/// Start of the PT,    takes up 0x1000 = 8 * 0x200 bytes
pub const PT_START: *mut [u64; 0x200] = 0x23000 as *mut [u64; 0x200];
